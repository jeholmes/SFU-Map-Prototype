...
- (void)drawRect:(CGRect)rect {
	...
	//Fill background.
	CGRect background = CGRectMake(0,0,320,460);
	...
	int bleed = 10;
	int buffer = bleed+40; //Buffer height for search bar, if already accounted for, set to 0.
    ...
    CGContextShowTextAtPoint (context, 17.5, 145, "SFU", 3);
	CGContextSelectFont (context, "Helvetica-Oblique", h/20, kCGEncodingMacRoman);
	CGContextShowTextAtPoint (context, 25, 120, "Path", 4); 
